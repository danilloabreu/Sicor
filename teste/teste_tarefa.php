...
echo "O id da tarefa é".$tarefa->getId_tarefa()."<br>";
echo "O  resumo da tarefa é ".$tarefa->getResumo()."<br>";
echo "O  resposavel da tarefa é ".$tarefa->getResponsavel()."<br>";
echo "A data de abertura da tarefa é ".$tarefa->getData_abertura()."<br>";
